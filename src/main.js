...
$(document).ready(function() {
  $('#dateInput').submit(function(event) {
    ...
    $('#Next-Birthday-Earth').text("The next birthday for you is :"+birthdayInput.GetNextBirthdayEarth().toDateString()+" Year on Earth");
    $('#Next-Birthday-Mercury').text("The next birthday for you is :"+nextBirdays[0]+" Year on Mercury");
    $('#Next-Birthday-Venus').text("The next birthday for you is :"+nextBirdays[1]+" Year on Venus");
    $('#Next-Birthday-Mars').text("The next birthday for you is :"+nextBirdays[2]+" Year on Mars");
    $('#Next-Birthday-Jupiter').text("The next birthday for you is :"+nextBirdays[3]+" Year on Jupiter");
